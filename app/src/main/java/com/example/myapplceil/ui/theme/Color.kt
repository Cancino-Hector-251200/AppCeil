package com.example.myapplceil.ui.theme
...
val NavyLight = Color(0xFF1C2541)
val White = Color(0xFFFFFFFF)
val Black = Color(0xFF000000)
val GrayInput = Color(0xFFF5F5F5)

val BackgroundScreen = Color(0xFF0B1120)
val BlueAdmin = Color(0xFF3B82F6)
val GreenAdmin = Color(0xFF22C55E)
val YellowAdmin = Color(0xFFFACC15)
val PinkAdmin = Color(0xFFF000D8)
